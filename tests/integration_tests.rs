...
fn test_all() {
    assert_exact_mutants_from_json(
        ...
        &vec![
            ...
            ("BinaryOpMutation", "-", "+", (8, 10)),
            ("BinaryOpMutation", "-", "*", (8, 10)),
            ("BinaryOpMutation", "-", "/", (8, 10)),
            ("BinaryOpMutation", "-", "%", (8, 10)),
            ("BinaryOpMutation", "-", "**", (8, 10)),
            ("SwapArgumentsOperatorMutation", "x - y", "y - x", (8, 9)),
            // SwapArgumentOperatorMutation
            ("BinaryOpMutation", "-", "+", (7, 10)),
            ("BinaryOpMutation", "-", "*", (7, 10)),
            ("BinaryOpMutation", "-", "/", (7, 10)),
            ("BinaryOpMutation", "-", "%", (7, 10)),
